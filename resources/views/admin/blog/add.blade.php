					                            ...
					                            <div class="box-body clearfix">
					                                <div class="col-sm-4">
					                                    ...
					                                    <div class="form-group">
					                                        ...
					                                        <div class="col-sm-10">
					                                        	<div style="display: inline-block;margin-right: 15px;">
					                                        		<input type="radio" name="b_status" value="1"  checked="" style='opacity: 1;top: 5px;left:17px'>
			                                                    	Hiển thị
					                                        	</div>
			                                                    <div style="display: inline-block;margin-right: 15px;">
			                                                    	<input type="radio" name="b_status" value="0"   style='opacity: 1;top: 5px;left:17px'>
			                                                    	Ẩn
			                                                    </div>
					                                        </div>
					                                    </div>
														<div class="form-group">
															...
															<div class="col-sm-10">
																<div style="display: inline-block;margin-right: 15px;">
																	<input type="radio" name="hot" value="1"   style='opacity: 1;top: 5px;left:17px'>
																	Bật
																</div>
																<div style="display: inline-block;margin-right: 15px;">
																	<input type="radio" name="hot" value="0" checked=""  style='opacity: 1;top: 5px;left:17px'>
																	Tắt
																</div>
															</div>
														</div>
					                                ...
					                                <div class="col-sm-8">
					                                    <div class="form-group">
					                                        ...
					                                        <div class="col-sm-10">
																<select class="form-control" name="b_category_id" id="">
																	...
																	<option value="{{$value->id}}">{{$value->cpo_name}}</option>
																	@endforeach
																</select>
																@if($errors->first('b_category_id'))
														...
														<div class="form-group">
															...
															<div class="col-sm-10">
																<input type="text" class="form-control" name="b_name" value="{{ old('b_name') }}"  placeholder="" autocomplete="off">
					                                    ...
					                                    <div class="form-group" >
							                                ...
							                                <div class="col-sm-10" >
							                                    <textarea name="b_description" cols="10" rows="10" class="form-control summernote" placeholder=" Please enter your message">{{ old('b_description') }}</textarea>
							                                    @if($errors->first('b_description'))
														...
														<div class="form-group" >
							                                ...
							                                <div class="col-sm-10" >
							                                    <textarea name="b_content"  cols="10" rows="10" class="form-control summernote" placeholder=" Please enter your message">{{ old('b_content') }}</textarea>
							                                    @if($errors->first('b_content'))
							                                        <span class="text-danger">{{ $errors->first('b_content') }}</span>
							                                    @endif
							                                </div>
							                                <div class="clearfix"></div>
							                            </div>
