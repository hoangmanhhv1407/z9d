            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            ...
                            <a href="index.html">Lịch sử nhập mã</a>
                        </li>
                    </ul>
                </div>
                <!-- /.box-body -->
                <form action="" method="GET">
                    <input type="text" name="name" value="{{ Request::get('name') }}" class="form-control"
                           style="width: 20%;display: inline-block" placeholder=" Tìm kiếm tên code ">
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                @foreach($showHistory as $key => $value)
                                    <tr>
                                        <td>{{$key + 1}}</td>
                                        <td>{{$value->user?$value->user->userid:''}}</td>
                                        <td>{{$value->giftCodeName->name}}</td>
                                        <td>{{$value->giftCodeName->giftCode->gift_code}}</td>
                                        <td>{!! $value->giftCodeName->giftCode->content !!}</td>
