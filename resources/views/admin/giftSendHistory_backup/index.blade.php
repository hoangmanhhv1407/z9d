        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="box-footer clearfix" style="margin-bottom: 20px;margin-top: 10px">
                                        <a href="{{route('admin.giftSendHistory.addLuckyIndex')}}" class="btn btn-sm btn-info btn-flat pull-left"><i
                                                    class="fa fa-plus " style="margin-right: 5px"></i>Thêm lượt quay</a>
                                        <a href="{{route('admin.giftSendHistory.addGiftVip')}}" class="btn btn-sm btn-info btn-flat pull-left"><i
                                                    class="fa fa-plus " style="margin-right: 5px"></i>Gửi quà theo cấp vip</a>
                    {{--                    @if(Request::get('type'))--}}
                                        ...
                                        <td>
                                            @if($value->status === 3)
                                                <a href="{{route('admin.giftSendHistory.send',[$value->id,1,$value->luckyNumber])}}"
                                                   class="btn btn-xs btn-warning" style="margin-top: 10px;">Gửi quà </a>
