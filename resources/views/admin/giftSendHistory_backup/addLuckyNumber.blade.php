                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            ...
                            <a href="index.html">Thêm lượt quay</a>
                        </li>
                    </ul>
                </div>
                <div class="inbox">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="js-example-responsive select-vip" name="vip"
                                                        ...
                                                        <option value="0-99">0 - 99 (VIP 0)</option>
                                                        <option value="100-199">100 - 199 (VIP 1)</option>
                                                        <option value="200-499">200 - 499 (VIP 2)</option>
                                                        <option value="500-999">500 - 999 (VIP 3)</option>
                                                        <option value="1000-1999">1000 - 1999 (VIP 4)</option>
                                                        <option value="2000-4999">2000 - 4999 (VIP 5)</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    {{--                                                    </select>--}}
                                                    <select class="js-example-responsive" name="user"
                                                            style="width: 100%">
                                                        <option value="">-- Chọn --</option>
                                                        @foreach($user as $value)
                                                            <option value="{{$value->id}}">{{$value->userid}}</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.select-vip').on('change', function () {
                ...
                let url = `{{route('admin.giftSendHistory.getUserVip')}}`
                $.ajax({
                    url: url,
                    type: "post",
                    dataType: "json",
