                        ...
                        <div class="box">
                            <div class="box-body">
                                ...
                                <div class="box box-primary clearfix">
                                    <form class="form-horizontal" action="{{route('admin.cateBlog.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="box-body clearfix">
                                            <div class="col-sm-8 col-sm-offset-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="cpo_name" value="{{ old('cpo_name') }}" placeholder="" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div style="display: inline-block;margin-right: 15px;">
                                                            <input type="radio" name="cpo_active" value="1" checked="" style='opacity: 1;top: 5px;left:17px'>
                                                            Hiển thị
                                                        </div>
                                                        <div style="display: inline-block;margin-right: 15px;">
                                                            <input type="radio" name="cpo_active" value="0" style='opacity: 1;top: 5px;left:17px'>
                                                            Ẩn
                                                        </div>
                                                    </div>
                                                </div>
