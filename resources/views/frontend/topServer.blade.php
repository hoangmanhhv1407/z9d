...
@section('content')
    ...
    <div class="content">
{{--        <img src="frontend/images/base/topLevel.png" style="position: absolute;top: 84px;width: 1200px;z-index: 9;">--}}
{{--        <div style="position: absolute;--}}
{{--    top: 115px;">--}}
{{--            <img src="/frontend/images/base/topLevel.png" style="position: absolute;--}}
{{--    top: 0;--}}
{{--    width: 1210px;--}}
{{--    z-index: 9;--}}
{{--    left: -38px;--}}
{{--    height: 530px;">--}}
        ...
        <div id="sessions-2">
            ...
            <div class="session-left" style="width: 100%;">
                ...
                <div class="news-link" style="border-top: 12px solid #3a2917;">
...
{{--                    </ul>--}}
                    ...
                    <div class="news-content-tab" style="background: #fff">
                        <div class="container">
                            <div class="block download2 hyhy" style="padding: 60px 70px 40px 70px;">
