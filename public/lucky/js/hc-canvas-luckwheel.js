    ...
    function draw(opts) {
        ...
        for (var i = 0; i < num; i++) {
            ...
            if (opts.mode == "both") {
                ...
                html.push('<img style="width: 50px;height: 50px" src="' + prizeList[i].img + '" />');
    ...
    function events() {
        bind(btn, "click", function() {
            ...
            fnGetPrize(function(data) {
                ...
                console.log('deg', deg, data, num)
                runRotate(deg);
            });
            console.log('setimeout', container, transitionEnd)
                // setTimeout(()=>{
                //   console.log('setimeout1')
                //
                // },3000)
                // console.log('setimeout12')
