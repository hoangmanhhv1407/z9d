    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
                "<a class='btn default dropdown-toggle" + size + "' data-bs-toggle='dropdown' href='#'>" +
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a href='#' class='btn default' data-bs-dismiss='modal'>" + locale.link.cancel + "</a>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                "<a href='#' class='btn default' data-bs-dismiss='modal'>" + locale.image.cancel + "</a>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-' + options.size : '';
            return "<li class='dropdown'>" +
                "<a class='btn default dropdown-toggle" + size + "' data-bs-toggle='dropdown' href='#' tabindex='-1'>" +
